#############################################################################
# Makefile for building: emustart
# Generated by qmake (3.1) (Qt 5.15.8)
# Project:  emustart.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile emustart.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_QML_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_SQL_LIB -DQT_XML_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -g -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -fpermissive -g -std=gnu++1z -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtSql -I/usr/include/qt5/QtXml -I/usr/include/qt5/QtCore -I. -I/usr/lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = emustart1.0.0
DISTDIR = /home/netpipe/qtprojects/emustart/emustart-github/launcher/.tmp/emustart1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) /usr/lib64/libQt5Widgets.so /usr/lib64/libQt5Gui.so /usr/lib64/libQt5Sql.so /usr/lib64/libQt5Xml.so /usr/lib64/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = 
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		emustart.pro  main.cpp
QMAKE_TARGET  = emustart
DESTDIR       = 
TARGET        = emustart
...
Makefile: emustart.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/lex.prf \
		emustart.pro
	$(QMAKE) -o Makefile emustart.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
moc_predefs.h: /usr/lib64/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -fpermissive -g -std=gnu++1z -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib64/qt5/mkspecs/features/data/dummy.cpp
...
main.moc: main.cpp \
	...
	/usr/lib64/qt5/bin/moc $(DEFINES) --include /home/netpipe/qtprojects/emustart/emustart-github/launcher/moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/netpipe/qtprojects/emustart/emustart-github/launcher -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtSql -I/usr/include/qt5/QtXml -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-suse-linux -I/usr/include/c++/7/backward -I/usr/lib64/gcc/x86_64-suse-linux/7/include -I/usr/local/include -I/usr/lib64/gcc/x86_64-suse-linux/7/include-fixed -I/usr/x86_64-suse-linux/include -I/usr/include main.cpp -o main.moc
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/emustart/bin || mkdir -p $(INSTALL_ROOT)/opt/emustart/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/emustart/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/emustart/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/emustart/bin/ 
